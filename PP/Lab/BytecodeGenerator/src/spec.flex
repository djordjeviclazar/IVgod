...
//konstante
{cifra}+ { return new Symbol( sym.CONSTINTEGER, yyline, new Integer(yytext())); }
\".*\" { return new Symbol( sym.CONSTSTRING, yyline, new String(yytext()) );} //
-?[0-9]+\.[0-9]+ { return new Symbol( sym.CONSTDOUBLE, yyline, new Double(yytext()));} // 
